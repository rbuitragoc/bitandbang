...
const data = {
  ...
  bio: chalk.gray('Engineering complex systems + Unleashing dev team power '),
  work: chalk.white('💻 ') + chalk.white('Staff Engineer / Engineering Lead'),
  twitter: chalk.gray('https://twitter.com/') + chalk.cyan('deekattax'),
  github: chalk.gray('https://github.com/') + chalk.yellow('rbuitragoc'),
  jsonresume: chalk.gray('https://registry.jsonresume.org/') + chalk.green('rbuitragoc'),
